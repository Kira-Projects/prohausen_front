        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center gap-4">
              ...
              <a 
                href="https://www.instagram.com/prohausen.cl/" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://www.youtube.com/@Prohausen" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://www.linkedin.com/company/prohausen/" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://api.whatsapp.com/send?phone=56940454965&text=Hola%20Prohausen%2C%20me%20gustaría%20tomar%20contacto%20contigo" 
                target="_blank" 
                rel="noopener noreferrer"
            ...
            <div className="flex justify-center">
              <a 
                href="https://www.trustpilot.com/review/prohausen.cl" 
                target="_blank" 
                rel="noopener noreferrer"
