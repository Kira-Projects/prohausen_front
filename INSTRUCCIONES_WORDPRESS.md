...
### 🔍 Campos Comunes de Estatik que Podrías Agregar:

Si necesitas más campos, aquí hay una lista de campos comunes de Estatik:

```php
// Otros campos posibles de Estatik
'garage' => get_post_meta($post_id, 'es_property_garage', true),
'parking_spaces' => get_post_meta($post_id, 'es_property_parking_spaces', true),
'half_baths' => get_post_meta($post_id, 'es_property_half_baths', true),
